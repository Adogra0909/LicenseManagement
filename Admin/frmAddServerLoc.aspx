<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmAddServerLoc.aspx.cs" Inherits="frmAddServerLoc" EnableEventValidation="false" %>
                          ...
                          <%--  <label class="control-label ">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <asp:RequiredFieldValidator ID="Rfvtxtstatecode" runat="server" ControlToValidate="txtserverlocCode" ErrorMessage="Required" Font-Bold="true" ForeColor="Red" ValidationGroup="btnSave"></asp:RequiredFieldValidator>
                                    </label>
                                    <asp:TextBox ID="txtserverlocCode" runat="server" CssClass="form-control form-control-sm" AutoComplete="off"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-10">
                                    ...
                                    <asp:RequiredFieldValidator ID="Requiredtxtstatename" runat="server" ControlToValidate="txtserverlocName" ErrorMessage="Required" Font-Bold="true" ForeColor="Red" ValidationGroup="btnSave"></asp:RequiredFieldValidator>
                                    </label>
                                    <asp:TextBox ID="txtserverlocName" runat="server" CssClass="form-control form-control-sm" AutoComplete="off"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-4">
                                ...
                                <asp:Label ID="lblsofname" runat="server" Text="Server Location Details" Font-Size="Larger" ForeColor="Black"></asp:Label>
                        ...
                        <asp:GridView GridLines="None" ID="gvstate" runat="server" DataKeyNames="ServerLocCode" AutoGenerateColumns="false" CssClass="table table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ServerLocCode" HeaderText="Server Location Code" NullDisplayText="0" />
                                <asp:BoundField DataField="ServerLocName" HeaderText="Server Location Name" NullDisplayText="0" />
