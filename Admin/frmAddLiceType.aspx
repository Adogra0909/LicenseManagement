<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmAddLiceType.aspx.cs" Inherits="frmAddLiceType" EnableEventValidation="false" %>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <label class="control-label ">
                            License Type Code :
                                    <asp:RequiredFieldValidator ID="Rfvtxtlicensetypecode" runat="server" ControlToValidate="txtlicensetypecode" ErrorMessage="Required" Font-Bold="true" ForeColor="Red" ValidationGroup="btnSave"></asp:RequiredFieldValidator>
                        </label>
                        <asp:TextBox ID="txtlicensetypecode" runat="server" CssClass="form-control form-control-sm" AutoComplete="off"></asp:TextBox>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-10">
                        <label class="control-label ">
                            License Type Name :
                                    <asp:RequiredFieldValidator ID="rfvtxtlictypeName" runat="server" ControlToValidate="txtlictypeName" ErrorMessage="Required" Font-Bold="true" ForeColor="Red" ValidationGroup="btnSave"></asp:RequiredFieldValidator>
                        </label>
                        <asp:TextBox ID="txtlictypeName" runat="server" CssClass="form-control form-control-sm" AutoComplete="off"></asp:TextBox>
                    </div>
                </div>
                   ...
                   <%-- <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="lblsofname" runat="server" Text="License Type Details" Font-Size="Larger" ForeColor="Black"></asp:Label>
                        ...
                        <asp:GridView GridLines="None" ID="gvstate" runat="server" DataKeyNames="LicTypeCode" AutoGenerateColumns="false" CssClass="table table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LicTypeCode" HeaderText="License Type Code" NullDisplayText="0" />
                                <asp:BoundField DataField="LicTypeName" HeaderText="License Type Name" NullDisplayText="0" />
